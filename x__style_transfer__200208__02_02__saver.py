...
# USE:
# python this.py style_img_path.jpg target_img_path.jpg stylized_result_path.jpg
...
res_max_dim = 1024 # Resolution of the Style Transfer
...
style_outputs = style_extractor(style_image*255) #@STCGoal Might be what I want to save?

#@STCGoal Save Model Attempt
saver = tf.train.Saver()
sess = tf.Session()
saver.save(sess, 'style-02_02-model')
...
image = tf.Variable(content_image) #@STCGoal Does that is what I want to save?
