...
export goalline="Acrylic painting style transfered to photos sequence painted"
echo $goalline
...
export content_imgname=jgi__destro__fullframe.jpg
export iterationgoal="Original Photo no modif"
...
export suffix=_002
export style_imgname=jgi_acrylic__plume__mtn.jpg
export content_imgname=jgi__destro__fullframe__paint01.jpg
export iterationgoal="Photo painted 01"
...
# (fewer NST Pass(5)
# The current NST Transfer Python Script to use for the Style Transfer 
export nst_script=x__style_transfer__200316__06_01low.py
...
#----------------------------------------------------
#--@a Customize that foreach variations
export suffix=_001low
export style_imgname=jgi_acrylic__plume__mtn.jpg
export content_imgname=jgi__destro__fullframe.jpg
export iterationgoal="Original Photo no modif (fewer NST Pass(5)"
...
#----------------------------------------------------
#--@a Customize that foreach variations
export suffix=_002low
export style_imgname=jgi_acrylic__plume__mtn.jpg
export content_imgname=jgi__destro__fullframe__paint01.jpg
export iterationgoal="Photo painted 01 - Fewer NST Pass(5)"
